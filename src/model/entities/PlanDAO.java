	...
	public void insertPlan(Plan plan) {
		...
		try {
			...
			String sql = "INSERT INTO javalar (nome, matricula, nome_arquivo, " + bugString + ", " + devString + ", "
					+ velocityString + ", " + daysString + ", " + yearsString + ", " + bugsInQuadrantsString + ", "
					+ devsInQuadrantsString + ") " + "VALUES ('José Vanderlei Furtuna Tomé', 554397, '"
					+ plan.getInstant().getFileName() + "', " + bugValues + ", " + devValues + ", " + velocityValues
					+ ", " + daysValues + ", " + yearsValues + ", " + bugsInQuadrantsValues + ", "
					+ devsInQuadrantsValues + ")";
